...
import { StyleSheet, SafeAreaView, TextInput, TouchableOpacity, ScrollView, RefreshControl, Image, View as RNView } from 'react-native';
  ...
  return (
      <SafeAreaView style={styles.container}>
        <RNView style={styles.heroContainer}>
          <Image
              source={{uri: 'https://images.pexels.com/photos/3785147/pexels-photo-3785147.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'}}
              style={styles.heroImage}
          />
          <RNView style={styles.heroOverlay}>
            <Text style={styles.heroTitle}>Natural Beauty</Text>
            <Text style={styles.heroSubtitle}>Discover products for your skin type</Text>
          </RNView>
        </RNView>
